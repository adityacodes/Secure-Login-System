        ...
        <div class="card">
                ...
                <div class="col-lg-12">
			    		...
			    		<div class="header">
			                ...
			                <h4 class="title" style="font-weight: bold;">CREATE NEW NEWS
								<button type="button" class="btn btn-primary pull-right" onclick="window.location='{{ route("admin.news.index") }}'">Cancel</button>
			                </h4>
		                ...
		                <div class="content">
		                	<h4>
					    	{!! Form::open(array('route' => 'admin.news.store', 'class' => 'form-horizontal', 'data-parsley-validate' => '', 'autocomplete' => 'off')) !!}
					                    ...
					                    <div class="form-group">
						                    {!! Form::submit('Create News', array('class' => 'btn pull-down btn-success btn-lg col-lg-8 col-md-offset-2 col-xs-offset-3 text-center', 'id' => 'submit'  )) !!}
						                </div>
							{!! Form::close() !!}
							</h4>
				    	</div>
