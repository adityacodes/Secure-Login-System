	...
	<div style="border-bottom: solid 3px #8E846B;">
		<div class="easyui-panel" style="background-color: #FEF8E4; color: #3F0D13; padding-top: 10px; border: 0px;">
			...
			<div style="float: left; display: inline-block">
				...
				<a href="{{ url('admin/participants') }}" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-pp'">Participants</a>
				<a href="{{ url('admin/orders') }}" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-mavro'">Orders</a>
				<a href="{{ url('admin/assignments') }}" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-account'">Assignments</a>
			</div>
