...
<head>
    ...
    <title>@yield('title') | Admin Theme</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">GTP ADMIN</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="{{Request::is('admin/support')? "active" : ""}}">
                            <a href="{{url('admin/support')}}"><i class="fa fa-table fa-fw"></i> Support</a>
                        </li>

                        <li class="{{Request::is('admin/assignments')? "active" : ""}}">
                            <a href="{{url('admin/assignments')}}"><i class="fa fa-table fa-fw"></i> Assignments</a>
                        </li>
